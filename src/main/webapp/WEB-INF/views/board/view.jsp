			...
			<div class="form">
				...
				<div class="prevAndNext">
					<div class="item">
						...
						<a
							href="../board/View.do?no=${prevBoard.no }&num=${prevBoard.num}&cate_select=${param.cate_select}&search_select=${param.search_select}&search_word=${param.search_word}">${prevBoard.title }</a>
					</div>
					<div class="item">
						<div class="direc">
						...
						<a
							href="../board/View.do?no=${nextBoard.no }&num=${nextBoard.num}&cate_select=${param.cate_select}&search_select=${param.search_select}&search_word=${param.search_word}">${nextBoard.title }</a>
