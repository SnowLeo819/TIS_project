...
<main>
	<div class="inner">
		...
		<div id="contents">
			...
			<form method="POST" action="../member/EditProcess.do" id="editmypage"
				...
				<table class="left">
					...
					<tbody>
						...
						<%--학생한테 안 보여도 될 거 같아서 일단 주석처리 해놨습니다. 
							<tr>
							<th>식별코드 </th>
							<td><input type="text" name="code" id="user_code"
							value="${member.code}"readonly></td> 
						</tr> --%>
						<tr>
							<th>이름 </th>
						...
						<tr>
							...
							<td>
								<select name="tellFirst" class="short">
								 ...
								 <input type="text" name="tellMiddle" class="short"
									id="user_phone_middle"  value="${member.tellMiddle}">
								<input type="text" name="tellLast" class="short" id="user_phone_last" value="${member.tellLast}"></td>
						</tr>
						<tr>
							<th>과목 </th>
