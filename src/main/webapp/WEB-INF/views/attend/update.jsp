...
<main>
	<div class="inner">
		...
		<div id="contents">
			...
			<form method="POST" action="../attend/AttendUpdateProcess.do" id="join"
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="name" id="name"
								value="${attendDto.name}" readonly class="readonly"></td>
						</tr>
						<tr>	
							<th>과정</th>
							<td>
					 ...
					 <tr>
							...
							<th>날짜</th>
							<td>
							<input type="date" name="attendDate"
								id="attendDate" readonly class="readonly" value="<fmt:formatDate value="${loattendDate }" pattern="yyyy-MM-dd" />"></td>
						</tr>
						<tr>
							<th>출석</th>
							<td>
							<fmt:parseDate value="${attendDto.attendTime }" var="loattendTime"  pattern="yyyy-MM-dd HH:mm:ss.S" />
							<input type="TIME" name="attendTime"
								id="attendTime" value="<fmt:formatDate value="${loattendTime }" pattern="HH:mm" />"></td>
						</tr>
						...
						<tr>
							...
							<td><input type="TIME" name="leaveTime"
								id="leaveTime" value="<fmt:formatDate value="${loleaveTime }" pattern="HH:mm" />"></td>
						</tr> 
						 	
						<tr>
							<th>출결확인</th>
							<td>
							<input type="radio" name="state" id = "state" value="출석">출석
							<input type="radio" name="state" id = "state" value="지각">지각
